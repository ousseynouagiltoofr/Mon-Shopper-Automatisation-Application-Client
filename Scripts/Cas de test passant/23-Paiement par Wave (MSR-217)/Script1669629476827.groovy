...
Mobile.tap(findTestObject('Object Repository/16-Ajouter les informations de l expéditeure en mode Guest/android.widget.ImageView'), 0)
...
Mobile.tap(findTestObject('Object Repository/16-Ajouter les informations de l expéditeure en mode Guest/android.widget.Button'), 0)
...
Mobile.verifyElementVisible(findTestObject('17-Ajouter les informations du destinataire en mode Guest/android.widget.EditText - Commentaire sur la livraison'), 
    0)
