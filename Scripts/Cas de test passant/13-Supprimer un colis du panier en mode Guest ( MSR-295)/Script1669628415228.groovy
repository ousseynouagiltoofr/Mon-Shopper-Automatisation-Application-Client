...
Mobile.tap(findTestObject('13-Supprimer un colis du panier/android.widget.ImageViewBaume'), 0)

Mobile.verifyElementNotVisible(findTestObject('13-Supprimer un colis du panier/android.widget.ImageViewBaume'), 0)
